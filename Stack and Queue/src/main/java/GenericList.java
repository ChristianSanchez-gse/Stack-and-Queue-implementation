...
public abstract class GenericList < T > implements Iterable < T > {
    ...
    public class Node < T > {
        ...
        public void setprevious(Node < T > curr) {
            this.previous = curr;
        }
    ...
    public GLLIterator < T > listIterator(int index) {
        GLLIterator < T > iter = new GLLIterator < T > (this.getHead(), index);
        return iter;
    }

    public Iterator < T > descendingIterator() {
        ReverseGLLIterator < T > iter = new ReverseGLLIterator < T > (this.getHead());
        return iter;
